        ...
        try {
            ...
            if (fs.existsSync(path)) {
                if (options.overwrite) {
                    ...
                    throw new errors_1.RvfError(errors_1.RvfErrorCode.FileExists, `${path} already exists; use RvfDatabase.open() to reuse it, or pass { overwrite: true } to replace it`);
                }
            }
